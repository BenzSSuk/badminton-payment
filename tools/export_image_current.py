...
folder_player_checked = os.path.join(FOLDER_PROJECT, 'player', 'checked')
list_dir, list_folder, list_file = wedolib.findFile(folder_player_checked, '2023', searchBy='partOfName')
